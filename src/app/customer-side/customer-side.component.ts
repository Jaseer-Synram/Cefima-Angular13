...
export class CustomerSideComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  @ViewChild(SignaturePad, { read: SignaturePad }) signaturePad: SignaturePad;
  ...
  currentid: any = this.userService.getDecodedAccessToken(
  ...
  title: any = this.userService.getDecodedAccessToken(
    localStorage.getItem("token")!
  ).title;
  lastname: any = this.userService.getDecodedAccessToken(
    localStorage.getItem("token")!
  ).lastname;
  firstname: any = this.userService.getDecodedAccessToken(
    localStorage.getItem("token")!
  ).firstname;
  id: any = this.userService.getDecodedAccessToken(
    localStorage.getItem("token")!
  ).id;
  COMPANYNAME: any = this.userService.getDecodedAccessToken(
    localStorage.getItem("token")!
  ).companyname;

  header_title: any = this.title;
  header_firstname: any = this.firstname;
  header_lastname: any = this.lastname;
  header_companyname: any = this.COMPANYNAME;
    ...
    for (let i = 0; i < filesLength; i++) {
      ...
      fileReader.onload = function (e) {
        ...
        if (
          ...
          $(
            '<div class="pip col-md-4" style="display: inline-block;margin-top: 8px;" "id=\'pipremove' +
            newsize +
            "'>" +
            '<div class="row">' +
            '<div class="col-md-12">' +
            ...
            "</div>" +
            '<div class="col-md-2">' +
            '<img class="imageThumb" style="width: 180%;height:30px;margin-top: 20px;" src="' +
            ImageName +
            '" title="' +
            f.name +
            '"/>' +
