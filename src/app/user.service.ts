...
export class UserService {
  ...
  get_calendar_events_by_user(data) {
    return this.http.post(
  ...
  get_document_url_by_document_unique_id(data) {
  ...
  get_user_email_configuration(user_id) {
    return this.http.get(
