...
export class B2bCreateCustomerComponent implements OnInit,AfterViewInit {
        ...
        updatedshares =
          ...
          parseInt(
            this.secondcompanyaddressFormGroup2.controls
              .legalrepresentativeform2.value[i].shares
          );
      }
...
if(data11['status']=='200')
{
  ...
  handleAddressChangeCompany(data) {
    const splitArr = data.address_components;
