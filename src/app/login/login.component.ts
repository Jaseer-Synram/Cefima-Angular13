    ...
    if (this.ProductsControl.value.name != "") {
      if (this.ProductsControl.value.name) {
        let obj = this.ProductTypeAndProductPartner.find((o: any, i: any) => {
          if (
            o.ProductType ===
            `${this.ProductsControl.value.name.toUpperCase()}   -->  Produkt  ${
              this.ProductsTypeControl.value
            }`
          ) {
            return true; // stop searching
          }
        ...
        if (obj) {
          ...
          this.ProductTypeAndProductPartner.push({
            ProductType: `${this.ProductsControl.value.name.toUpperCase()}   -->  Produkt  ${
              this.ProductsTypeControl.value
            }`,
